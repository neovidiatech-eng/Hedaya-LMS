...
const AuthLayout = () => {
  ...
  const logoSrc = settings.logoUrl || "/logo1.png";
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3">
              <img
                src={logoSrc}
                alt="logo"
                className="w-12 h-12 rounded-2xl object-contain bg-white/20 backdrop-blur-md p-1.5 border border-white/10"
              />
          ...
          <div className="w-full">
            ...
            <div className="flex lg:hidden flex-col items-center text-center mb-8">
              <img
                src={logoSrc}
                alt="logo"
                className="w-16 h-16 rounded-2xl object-contain bg-primary/5 p-2 border border-primary/10 mb-3"
              />
